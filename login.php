			...
			<div class="row">
				<div id="page-wrapper" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4" style="background-color: #ffffff; border-radius: 3px; webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05); box-shadow: 0 1px 1px rgba(0,0,0,.05)">
					<div class="row">
						<div class="col-lg-12">
							<br/>
							<center><img src="libs/images/gvp-logo.png" width="380" height="120"></center>
							<h2 class="text-center">Sistem Informasi Pengajuan Cuti<br/> <b>PT. Gracia Visi Pratama</b></h2>
						</div>
					</div><!-- /.row -->
					<div class="row">
						<div class="col-lg-12">
