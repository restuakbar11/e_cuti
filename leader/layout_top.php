...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online PT. GVP Indonesia - <?php echo $pagedesc ?></title>

	<link href="libs/images/gvp-logo.png" rel="icon" type="images/x-icon">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../libs/images/gvp-logo.png" alt="brand" width="150" class="float-left image-brand">
					<!-- <div class="float-right">&nbsp;<strong>PT. GVP Indonesia</strong></div> -->
					<div class="clear-both"></div>
				</a>
				<a class="navbar-brand visible-xs" href="index.php">
					<img src="../libs/images/GVP-logo.jpg" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>PT. GVP Indonesia</strong></div>
					<div class="clear-both"></div>
				</a>
			</div><!-- /.navbar-header -->
